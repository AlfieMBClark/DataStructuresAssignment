...
// Function declarations for merge sort (not touching these, assuming your friend already uses these)
void MergeSort(void* dataArray, void* Buffer, int rowSize, int left, int right, int colIndex, int fieldLen);

// Functions for sorting transactions, reviews, and word counts
...
// Function declarations for heap sort and heapify (for transactions)
